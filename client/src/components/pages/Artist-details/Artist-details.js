...
class ArtistDetails extends Component {
  ...
  addFavourite = (artist_id) => {
    ...
    this.artistsService
      ...
      .then(() =>
        this.authService.editUser(this.props.loggedUser._id, {
  ...
  render() {
    return (
      <>
        <Container className="artist-details">
          ...
          <Row>
            ...
            <Col md={4}>
              ...
              {this.props.loggedUser != undefined && this.props.loggedUser.role == "admin" && (
        ...
        <Modal
          show={this.state.showModal} onHide={() => this.handleModal(false)} >
          <Modal.Body>
